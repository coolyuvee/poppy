...
REGION_COUNTRY_MAPPING = {
    ...
    'EMEA(Europe, Middle East and Africa)': [
        ...
        'San Marino', 'Saudi Arabia', 'Senegal, Seychelles', 'Serbia',
        'Sierra Leone', 'Slovakia', 'Slovenia', 'Somalia', 'South Africa',
        'Spain', 'St Helena', 'Sudan', 'Svalbard', 'Swaziland', 'Sweden',
        'Switzerland', 'Syria', 'Tanzania', 'Togo', 'Tunisia', 'Turkey',
        'Uganda', 'United Arab Emirates', 'United Kingdom', 'Vatican City',
