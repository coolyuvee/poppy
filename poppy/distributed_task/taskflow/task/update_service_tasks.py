...
class UpdateServiceDNSMappingTask(task.Task):
    ...
    def revert(self, responders, retry_sleep_time,
        ...
        """Revert if updating the mapping between dns service and provider url fails.
...
class GatherProviderDetailsTask(task.Task):
    ...
    def execute(self, responders, dns_responder, log_responders, project_id,
        ...
        """Gathers the status of update service, update dns and log delivery.

        :param list[dict] responders: list of dict of responder
        :param dict dns_responder: dict of dns_responder
        :param list log_responders: list of log_responder
        :param unicode project_id: project id of the user
        :param unicode service_id: uuid of the service
        :param unicode service_obj: json object of the service
        :return: provider_details_dict_error_tuple tuple of dict and string
        :rtype: tuple
        """
